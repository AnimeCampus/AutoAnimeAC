...
async def auto_parser(TECHZ_API_KEY, app):
    ...
    Gogo.base = "http://api.techzbots.live"
    ...
    while True:
        try:
            ...
            logger.error(f"Error in auto_parser: {e}")
            traceback.print_exc()

        await asyncio.sleep(600)

# Call the auto_parser function with appropriate arguments
# asyncio.run(auto_parser("YOUR_TECHZ_API_KEY", your_app_object))
